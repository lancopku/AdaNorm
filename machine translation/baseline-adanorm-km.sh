save=deen_transformer_prenorm_km_init_adanorm_2_for_figure
init_method='km'
lnv='adanorm'
adanorm_scale=2
...
do
    ...
    --dropout 0.3  --lnv ${lnv} --adanorm_scale ${adanorm_scale} --init_method ${init_method}\
...
#save=deen_transformer_prenorm_km_init_adanorm_1.5
#adanorm_scale=1.5
#for seed in 1
#do
#    cur_save=${save}
...
#save=deen_transformer_prenorm_km_init_adanorm_1
#adanorm_scale=1
#for seed in 1
#do
#    cur_save=${save}
...
#save=deen_transformer_prenorm_km_init_adanorm_0.8
#adanorm_scale=0.8
#for seed in 1
#do
#    cur_save=${save}
