...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, args, embed_dim, num_heads, kdim=None, vdim=None, dropout=0., bias=True,
    ...
    def reset_parameters(self):
        if self.init_method == 'xavier':
            if self.qkv_same_dim:
                #print('qkv_init_scale',self.qkv_init_scale)
            ...
            if self.qkv_same_dim:
                ...
                if self.args.big_km and 'qkv' in self.args.big_km_list:
                    nn.init.kaiming_uniform_(self.in_proj_weight, a=1)
            else:
                if self.args.big_km and 'qkv' in self.args.big_km_list:
                    a = 1
                else:
