...
class TransformerEncoderLayer(nn.Module):
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def __init__(self, args):
        ...
        self.fc1 = Linear(self.embed_dim, args.encoder_ffn_embed_dim, args)
        self.fc2 = Linear(args.encoder_ffn_embed_dim, self.embed_dim, args)
...
class TransformerDecoderLayer(nn.Module):
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(self, args, no_encoder_attn=False, add_bias_kv=False, add_zero_attn=False):
        ...
        self.fc1 = Linear(self.embed_dim, args.decoder_ffn_embed_dim, args)
        self.fc2 = Linear(args.decoder_ffn_embed_dim, self.embed_dim, args)
...
def Linear(in_features, out_features, bias=True, args=None):
    ...
    if args is None:
        ...
        if args.init_method == 'xavier':
            nn.init.xavier_uniform_(m.weight)
            if cur_linear == 'fc1':
                nn.init.xavier_uniform_(m.weight, gain=1/ math.sqrt(args.fc1_init_scale))
            if cur_linear == 'fc2':
                nn.init.xavier_uniform_(m.weight, gain=1/ math.sqrt(args.fc2_init_scale))
