...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.project_in_dim = Linear(input_embed_dim, embed_dim, bias=False, args=args) if embed_dim != input_embed_dim else None
        ...
        self.project_out_dim = Linear(embed_dim, self.output_embed_dim, bias=False, args=args) \
